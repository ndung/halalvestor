...
public class QuantityView  extends LinearLayout implements View.OnClickListener {
    ...
    private java.text.DecimalFormat decimalFormat = new java.text.DecimalFormat("Rp ###,###,###");
    ...
    private String labelDialogTitle = "Masukkan Jumlah";
    private String labelPositiveButton = "Ubah";
    ...
    public void onClick(View v) {
        if (v == mButtonAdd) {
            if (quantity + 1 > maxQuantity) {
                ...
                int oldQty = quantity;
                quantity += 1;
                mTextViewQuantity.setText(decimalFormat.format(quantity));
            ...
            dialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
                    String newQuantity = et.getText().toString().replaceAll("\\,","").replaceAll("\\.","");
...
//            }
            ...
            mTextViewQuantity.setText(decimalFormat.format(this.quantity));
        } else {
            if (onQuantityChangeListener != null) onQuantityChangeListener.onLimitReached();
        }
    }

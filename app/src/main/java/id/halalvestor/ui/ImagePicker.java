...
public class ImagePicker {
    ...
    private static final String TEMP_IMAGE_NAME = "Halalvestor";
    ...
    public static Object[] getImageFromResult(Context context, int resultCode, Intent imageReturnedIntent) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            ...
            if (!isCamera) {     /** ALBUM **/
                ...
                absolutePath = imageCompressor.compressImageFromFilePath(getPath(context, selectedImage));
            }
            ...
            if (isCamera) {     /** CAMERA **/
                absolutePath = imageCompressor.compressImageFromFilePath(imageFile.getAbsolutePath());
            }
            Log.d(TAG, "absolutePath: " + absolutePath);
        }
        return new Object[]{selectedImage,bm,absolutePath};
    }

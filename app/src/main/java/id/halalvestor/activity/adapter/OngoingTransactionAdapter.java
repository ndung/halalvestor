...
public class OngoingTransactionAdapter extends RecyclerView.Adapter<OngoingTransactionAdapter.ViewHolder> {

    public interface OnItemClickListener {
        void onItemClick(Transaction model);
        void onConfirmed(Transaction model);
    }
    ...
    public OngoingTransactionAdapter(List<Transaction> list, OnItemClickListener listener) {
        this.list = list;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.history_transaction_item_layout, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.tvKonfirmasi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Log.d(TAG, "model:"+model);
                listener.onConfirmed(model);
            }
        });
    ...
    private static final String TAG = OngoingTransactionAdapter.class.toString();
